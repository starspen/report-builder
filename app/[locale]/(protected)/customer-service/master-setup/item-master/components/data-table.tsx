...
import { CSItemMasterDataTableToolbar } from "./data-table-toolbar";

interface CSItemMasterDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  user: any;
}

export function CSItemMasterDataTable<TData>({ columns, data, user }: CSItemMasterDataTableProps<TData>) {
  ...
  return (
    <div className="space-y-4">
      <CSItemMasterDataTableToolbar table={table} user={user} />
