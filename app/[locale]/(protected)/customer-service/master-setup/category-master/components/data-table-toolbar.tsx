...
export function DataTableToolbar({ table, user }: DataTableToolbarProps) {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => deleteCSMasterCategory(id),
    onSuccess: (data) => {
        ...
        <>
          <EditCategoryForm
            categoryData={{
              ...
              complain_type: selectedRows[0].complain_type,
            }}
          />
          ...
          >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Hapus category dengan kode:{" "}
                  {selectedRows[0].category_cd}?
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Tindakan ini tidak dapat dibatalkan. Data category akan
