...
import {
  deleteCSMasterCategoryGroup,
} from "@/action/customer-service-master";
import EditCategoryGroupForm from "../edit-category-group-form";
import NewCategoryGroupForm from "../new-category-group-form";
...
export function DataTableToolbar({ table, user }: DataTableToolbarProps) {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => deleteCSMasterCategoryGroup(id),
    onSuccess: (data) => {
  ...
  return (
    <div className="flex flex-1 flex-wrap items-center gap-2">
      <Input
        placeholder="Cari category group..."
      ...
      <NewCategoryGroupForm user={user} />
      ...
      {selectedRows.length === 1 && (
        <>
          <EditCategoryGroupForm
            categoryGroupData={{
              category_group_cd: selectedRows[0].category_group_cd,
          ...
          >
            <AlertDialogTrigger asChild>
              ...
              >
                ...
                Hapus Category Group
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Hapus category group dengan kode:{" "}
                  {selectedRows[0].category_group_cd}?
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Tindakan ini tidak dapat dibatalkan. Data category group akan
