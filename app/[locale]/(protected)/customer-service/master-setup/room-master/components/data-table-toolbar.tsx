...
export function DataTableToolbar({ table, user }: DataTableToolbarProps) {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => deleteCSMasterRoom(id),
    onSuccess: (data) => {
        ...
        <>
          <EditRoomForm
            roomData={{
              ...
              room_cd: selectedRows[0].room_cd,
          ...
          >
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>
                  Hapus room dengan kode:{" "}
                  {selectedRows[0].room_cd}?
                </AlertDialogTitle>
                <AlertDialogDescription>
                  Tindakan ini tidak dapat dibatalkan. Data room akan
