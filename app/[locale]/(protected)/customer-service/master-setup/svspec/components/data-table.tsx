...
interface SvspecDataTableProps<TData> {
  columns: ColumnDef<TData>[];
  data: TData[];
  user: any;
}

export function SvspecDataTable<TData>({
  columns,
  data,
  user,
}: SvspecDataTableProps<TData>) {
  ...
  const table = useReactTable({
    ...
    onRowSelectionChange:
      handleRowSelectionChange as OnChangeFn<RowSelectionState>,
