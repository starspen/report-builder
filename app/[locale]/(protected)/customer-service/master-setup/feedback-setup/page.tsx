...
import FeedbackSetupView from "./page-view";
    ...
    <div className="space-y-5">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>Feedback Setup</BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <Card>
        <CardHeader>
          <CardTitle>Feedback Setup</CardTitle>
        </CardHeader>
        <CardContent>
          <FeedbackSetupView session={session} />
        </CardContent>
      </Card>
    </div>
  );
