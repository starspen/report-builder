...
import ComplainSourceView from "./page-view";
    ...
    <div className="space-y-5">
      <Breadcrumb>
        <BreadcrumbList>
          ...
          <BreadcrumbSeparator />
          <BreadcrumbItem>Complain Source</BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <Card>
        <CardHeader>
          <CardTitle>Complain Source</CardTitle>
        </CardHeader>
        <CardContent>
          <ComplainSourceView session={session} />
        </CardContent>
      </Card>
    </div>
  );
