...
import { stampingEmeterai, stampingFile } from "@/action/emeterai-action";
...
export function DataTableToolbar({ table, source }: DataTableToolbarProps) {
  ...
  //       file_serial_number: row.file_serial_number,
  //       file_status: row.file_status,
  //       company_cd: "PROPERTYX",
  //     };
  //   });
  //   const result = await stampingFile(data);
  //   if (result.success) {
  //     toast.success("E-meterai stamped successfully");
  //   } else {
  //     toast.error("Failed to stamp e-meterai");
  //   }
  // };
