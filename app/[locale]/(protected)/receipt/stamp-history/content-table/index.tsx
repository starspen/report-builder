...
import { getReceiptStampHistory } from "@/action/receipt-action";
...
export default function AdvancedTable() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const result = await getReceiptStampHistory(
        formattedStartDate,
        formattedEndDate
      );
      return result;
  ...
  return (
    <Fragment>
      ...
      <DataTable
        data={data?.data || []}
        columns={columns}
        startDate={startDate ? format(startDate, "yyyyMMdd") : ""}
        endDate={endDate ? format(endDate, "yyyyMMdd") : ""}
      />
    </Fragment>
  );
}
