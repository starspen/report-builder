...
export const generateInvoiceSchedule = async (
  ...
  try {
    ...
    const response = await fetch(`${url}/api/invoice/schedule/generate`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const generateInvoiceManual = async (
  ...
  try {
    ...
    const response = await fetch(`${url}/api/invoice/manual/generate`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const reStampInvoice = async (
  fileName: string,
  fileType: string,
  processId: string
) => {
