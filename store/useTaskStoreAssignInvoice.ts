...
import { Task } from "@/app/[locale]/(protected)/master-data/assignment-invoice-revised/content-table/components/columns";

interface TaskStoreCopy {
...
const useTaskStore = create<TaskStoreCopy>()(
  persist(
    (set) => ({
    ...
    {
      name: "task-storage-assignment-invoice",
